...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px; margin: auto; border-collapse: collapse;">
    <tr>
        <td style="padding: 20px 0; text-align: center;">
            ...
            <h1 style="color: #1E1E1E; font-size: 28px; font-weight: bold;">Welcome <span style="color: #e60086;">Monabele</span></h1>
            <p style="color: #575757; font-size: 14px;">Your verification code 👇🏽</p>
        </td>
    </tr>
    <tr>
